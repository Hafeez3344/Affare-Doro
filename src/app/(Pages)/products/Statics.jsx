    ...
    <div className="pb-10">
      ...
      <div className="flex flex-col xl:flex-row gap-5 mt-[20px]">
        ...
        <div className="xl:w-[40%] bg-white rounded-[8px] shadow-sm">
          ...
          <p className="text-[18px] text-center mb-6">Average sales this week</p>
          <StaticsBarGraph />
        </div>
      </div>
      <div className="mt-[20px] flex flex-col xl:flex-row gap-5">
          ...
          <table className="w-[100%] mt-2">
            ...
            <tbody>
              <tr className="h-[45px]">
                ...
                <td>12 Jan, 2024</td>
                <td>
                  <div className="h-[25px] text-[11px] text-[#06E775] rounded-[5px] bg-green-100 flex justify-start items-center w-[max-content] px-3">Pending</div>
                </td>
              </tr>
              <tr className="h-[45px]">
                <td>PK08656</td>
        ...
        <div className="mt-5 flex flex-col gap-3">
          <div className="flex justify-between">
            ...
            <p className="font-[500]">126777 <span className="text-[var(--text-color-body)]">-12</span></p>
          </div>
          <div className="flex justify-between">
            <p className="text-[var(--text-color-body)] font-[500]">Units</p>
            <p className="font-[500]">64665 <span className="text-[var(--text-color-body)]">-44</span></p>
          </div>
          <div className="flex justify-between">
            <p className="text-[var(--text-color-body)] font-[500]">Buyers</p>
            <p className="font-[500]">8898 <span className="text-[var(--text-color-body)]">-12</span></p>
          </div>
          <div className="flex justify-between">
            <p className="text-[var(--text-color-body)] font-[500]">Unique Buyers</p>
            <p className="font-[500]">8898 <span className="text-[var(--text-color-body)]">-12</span></p>
          </div>
          <div className="flex justify-between">
            <p className="text-[var(--text-color-body)] font-[500]">Average Purchase</p>
            <p className="font-[500]">98989 <span className="text-[var(--text-color-body)]">-12</span></p>
          </div>
        </div>
        </div>
      </div>
